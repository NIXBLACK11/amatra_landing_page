    ...
    const plans = [
        {
            ...
            price: "$0",
            period: "/forever",
            description: "Dip your toes in. See what the style world has to offer.",
            accent: null,
            ...
            features: [
                ...
                { included: false, text: "Wardrobe limited to 10 items" },
                { included: false, text: "Copy or clone outfits" },
        ...
        },
        {
            ...
            price: "$4.99",
            period: "/month",
            description: "Build your wardrobe and start creating looks that are truly yours.",
            accent: colors.brand,
            textColor: '#000000',
            ...
            features: [
                ...
                { included: true, text: "Wardrobe up to 100 items" },
                { included: true, text: "Create & save 20 custom outfits" },
                { included: true, text: "Copy & clone public styles" },
                { included: true, text: "Advanced AI recommendations" },
                { included: false, text: "AI style assistant chat" },
                { included: false, text: "Early access to features" },
            ],
            cta: "Start Styling",
            ctaStyle: "filled",
            delay: 0.4,
        },
        {
            ...
            price: "$11.99",
            period: "/month",
            description: "The full creative suite. Unlimited expression, zero compromise.",
            accent: null,
            textColor: colors.text,
            bgColor: 'transparent',
            badge: { icon: false, label: "⚡ FULL ACCESS" },
            features: [
                { included: true, text: "150 AI try-ons per month" },
                { included: true, text: "Everything in Stylist" },
                { included: true, text: "Unlimited wardrobe items" },
                { included: true, text: "Unlimited custom outfits" },
                { included: true, text: "AI style assistant chat" },
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {[
                        { label: "1 try-on", sub: "Explorer" },
                        { label: "50 try-ons", sub: "Stylist" },
                        { label: "150 try-ons", sub: "Pro Creator" },
                    ].map((item, i) => (
